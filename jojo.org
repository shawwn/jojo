...
#+title: jojo
- basic generic function of obj_t
- k_lambda -- without local_ref_jo
- k_lambda -- handle local_ref_jo
- tk_assign -- handle `()`
- tk_assign -- handle `.`
- (data)
- hook in obj_t::assign -- (data) generate data_cons_o and data_pred_o
  - `recur` should be handled here
- (case)
* prolog
