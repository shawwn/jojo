...
#+title: core
- TypCell & TypCellDic for global-naming of type
  - we still need Tag for primitive types
- Tag -- to get type of primitive type -- by indexing into a const table
- Obj::typ () -- to get type of obj -- Data only
- fix unified function call syntax -- (<type-t>.method ...)
* [todo-stack]
