...
#+title: core
- fix type of prim-function for define_prim!
- `as_*` for all obj -- instead of `obj_to::<*>`
- use `*::make` for all obj -- instead of `*::obj`
- apply_compile handle (.method ...)
- maybe native List
- char-t -- #char"..." as literal
- path-t -- #path"..." as literal
* use
