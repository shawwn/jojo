...
#+title: core
- Vect and Dict without struct
- Str and Num without struct
- native List
- call_compile handle (.method ...)
* use
...
*** [todo] call_with_arg_dict_compile
